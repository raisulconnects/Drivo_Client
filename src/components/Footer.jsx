      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 md:grid-cols-3">
        ...
        <div>
          ...
          <div className="flex gap-3">
            {/* X (Twitter) — per spec: new X logo */}
            <span className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-xs text-gray-400 transition hover:border-white/20 hover:text-white">
              <svg
